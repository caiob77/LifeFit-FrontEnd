  ...
  const chatContent = (
    ...
    >
      ...
      <div className="flex shrink-0 flex-col">
        <div className="border-t border-border bg-secondary/40 px-5 py-2">
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-2 overflow-x-auto">
              {SUGGESTED_MESSAGES.map((suggestion) => (
                <button
                  ...
                  disabled={isLoading}
                  className="whitespace-nowrap rounded-full border border-primary/20 bg-background px-3 py-1 font-heading text-xs text-primary transition-colors hover:bg-primary/10 disabled:opacity-40"
                >
                  {suggestion}
                </button>
              ))}
