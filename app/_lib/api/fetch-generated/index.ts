...
/**
 * Retorna todos os planos de treino do usuário autenticado. Use o parâmetro `active` para filtrar apenas os planos ativos.
...
/**
 * Cria um novo plano de treino para o usuário autenticado com nome e dias de treino definidos.
...
/**
 * Retorna os detalhes completos de um plano de treino específico, incluindo todos os dias e exercícios cadastrados.
...
/**
 * Retorna os detalhes de um dia de treino específico, incluindo exercícios, séries e cargas registradas.
...
/**
 * Inicia uma nova sessão de treino para o dia informado. Retorna erro se o plano estiver inativo (422) ou se já houver uma sessão em andamento (409).
...
/**
 * Atualiza uma sessão de treino em andamento, registrando o horário de conclusão via `completedAt`.
...
/**
 * Retorna os dados da tela inicial para uma data específica, incluindo o treino programado e o resumo de progresso do usuário.
...
/**
 * Retorna os dados físicos do usuário autenticado: peso, altura, idade e percentual de gordura corporal.
...
/**
 * Cria ou atualiza os dados físicos do usuário autenticado (peso, altura, idade e percentual de gordura).
...
/**
 * Retorna as estatísticas de treino do usuário autenticado dentro de um intervalo de datas definido pelos parâmetros `from` e `to`.
